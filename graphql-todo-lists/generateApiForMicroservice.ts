...
// rm -rf __generated_api__ && mkdir __generated_api__ && java -jar ../swagger-codegen-cli.jar generate -l typescript-fetch -i http://localhost:8091/v3/api-docs.yaml -o __generated_api__p