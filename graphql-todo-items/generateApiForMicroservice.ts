...
shelljs.exec(`java -jar ../swagger-codegen-cli.jar generate -l typescript-fetch -i ${API_URL} -o ${API_DIR}`)

shelljs.sed("-i", /import \* as portableFetch/, "import portableFetch", `./${API_DIR}/api.ts`);
